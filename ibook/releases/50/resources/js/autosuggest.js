...
//                                    results +='<div class="col-xs-12 col-md-12 col-padding result-list" data-id="'+j.id+'" data-value="'+j.bookName +'">'+
//				        				      '    <p class="fr" style="display: inline-block;">'+ getStrongText(j.bookName, matchText)+'</p>'+
//				        				      '</div>';

                                    results+='<div class="home-search-result-item" data-id="'+j.id+'"  data-value="'+j.title +'" ><a href="/cartoons/'+j.id+'">'+ getStrongText(j.title, matchText)+'</a><div class="line"></div></div>'
...
//                                    results +='<div class="col-xs-12 col-md-12 col-padding result-list" data-id="'+j.id+'">'+
//		        				      '    <p class="fr" style="display: inline-block;">'+ j.bookName+'</p>'+
//		        				      '</div>';
                                    results+='<div class="home-search-result-item" data-id="'+j.id+'"  data-value="'+j.title +'"><a href="/cartoons/'+j.id+'">'+ getStrongText(j.title, matchText)+'</a><div class="line"></div></div>'
                                }
                                suggestionsNum++;
                        ...
                        $(that).keydown(function (event) {
                            ...
                            if (keyCode == 13) {
                                ...
                                if (upDownOperate) {
                                    ...
                                    lock = true;
                                    lastText = getRealText($(".as-selected").data('value'));
                                    var bookId=$(".as-selected").data('id');
                                    $(that).val(lastText);
